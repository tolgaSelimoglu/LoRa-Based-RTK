...
static void cgxe_mdl_start(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0_data[], int32_T
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2]);
static void mw__internal__system___fcn(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
...
static const mxArray *emlrt_marshallOut(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
...
static void init_simulink_io_address(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
  *moduleInstance);
...
static void cgxe_mdl_start(InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance)
{
  ...
  if (loop_ub - 1 >= 0) {
    memcpy(&b_u_tmp3_data[0], &(*moduleInstance->u0_data)[0], (uint32_T)loop_ub *
           sizeof(creal_T));
  }
  ...
  *moduleInstance)
{
  ...
  loop_ub = (*moduleInstance->u0_sizes)[0] * (*moduleInstance->u0_sizes)[1];
  if (loop_ub - 1 >= 0) {
    memcpy(&moduleInstance->u_tmp3_data[0], &(*moduleInstance->u0_data)[0],
           (uint32_T)loop_ub * sizeof(creal_T));
  }

  mw__internal__call__step(moduleInstance, &st, *SamplesPerSymbol,
    *DampingFactor, *NormalizedLoopBandwidth, moduleInstance->u_tmp3_data,
    u_tmp3_size, y_tmp0_data, y_tmp0_size);
  ...
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2])
{
  ...
  emlrtDimSizeGeqCheckR2012b(3326, b_y0_size[0], &emlrtECI, (void *)sp);
  ...
  creal_T output_data[], int32_T output_size[1])
{
  ...
  real_T phaseEstimate_data[3326];
  ...
  phaseEstimate_data[], int32_T phaseEstimate_size[1])
{
  emlrtStack b_st;
  emlrtStack st;
  creal_T phaseCorrection_data[3326];
  creal_T b;
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0_data = (creal_T (*)[3326])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->u0_sizes = (int32_T (*)[2])cgxertGetCurrentInputPortDimensions
    (moduleInstance->S, 0);
  moduleInstance->y0_data = (creal_T (*)[3326])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
...
/* CGXE Glue Code */
static void mdlOutputs_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S, int_T tid)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S, int_T tid)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
  InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *moduleInstance =
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF *)calloc(1, sizeof
    (InstanceStruct_BTWFqGYD8aagFTEBQPdwsF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_BTWFqGYD8aagFTEBQPdwsF);
  ssSetmdlInitializeConditions(S, mdlInitialize_BTWFqGYD8aagFTEBQPdwsF);
  ssSetmdlUpdate(S, mdlUpdate_BTWFqGYD8aagFTEBQPdwsF);
  ssSetmdlDerivatives(S, mdlDerivatives_BTWFqGYD8aagFTEBQPdwsF);
  ssSetmdlTerminate(S, mdlTerminate_BTWFqGYD8aagFTEBQPdwsF);
  ssSetmdlEnable(S, mdlEnable_BTWFqGYD8aagFTEBQPdwsF);
  ssSetmdlDisable(S, mdlDisable_BTWFqGYD8aagFTEBQPdwsF);
...
static void mdlProcessParameters_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S)
{
}

void method_dispatcher_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_BTWFqGYD8aagFTEBQPdwsF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_BTWFqGYD8aagFTEBQPdwsF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_BTWFqGYD8aagFTEBQPdwsF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_BTWFqGYD8aagFTEBQPdwsF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: BTWFqGYD8aagFTEBQPdwsF.\n"
...
mxArray *cgxe_BTWFqGYD8aagFTEBQPdwsF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_BTWFqGYD8aagFTEBQPdwsF_fallback_info(void)
{
