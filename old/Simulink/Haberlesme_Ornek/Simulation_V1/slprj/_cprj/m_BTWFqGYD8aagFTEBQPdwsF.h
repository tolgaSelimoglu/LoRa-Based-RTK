#ifndef __BTWFqGYD8aagFTEBQPdwsF_h__
#define __BTWFqGYD8aagFTEBQPdwsF_h__
...
#ifndef struct_tag_L64ifv7bV3tPzgi2aipsfH
#define struct_tag_L64ifv7bV3tPzgi2aipsfH

struct tag_L64ifv7bV3tPzgi2aipsfH
{
...
#endif                                 /* struct_tag_L64ifv7bV3tPzgi2aipsfH */

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct tag_L64ifv7bV3tPzgi2aipsfH comm_CarrierSynchronizer;

#endif                                 /* typedef_comm_CarrierSynchronizer */

#ifndef typedef_InstanceStruct_BTWFqGYD8aagFTEBQPdwsF
#define typedef_InstanceStruct_BTWFqGYD8aagFTEBQPdwsF

typedef struct {
  SimStruct *S;
  comm_CarrierSynchronizer sysobj;
  boolean_T sysobj_not_empty;
  creal_T u_tmp3_data[3326];
  void *emlrtRootTLSGlobal;
  creal_T (*u0_data)[3326];
  int32_T (*u0_sizes)[2];
  creal_T (*y0_data)[3326];
  int32_T (*y0_sizes)[2];
} InstanceStruct_BTWFqGYD8aagFTEBQPdwsF;

#endif                                 /* typedef_InstanceStruct_BTWFqGYD8aagFTEBQPdwsF */
...
extern void method_dispatcher_BTWFqGYD8aagFTEBQPdwsF(SimStruct *S, int_T method,
  void* data);
